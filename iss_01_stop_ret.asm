...
.copyFont
	...
	; But since I don't really know how it works, I'll non-zero IE and IF and enable interrupts with different interrupts for each so the handler doesn't get called
	...
	; This ROM does 'stop ret', except with 'dw $10, $c9' to make ultra sure it works
